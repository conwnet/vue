...
export function parse (html) {
    ...
    let currentParent;
    let stack = [];
    //? 这个 HTMLParser 里面的 start 的 unary 参数是干啥的？
    //! 简单看了一下面的代码，猜测应该是判断是否是单标签
    HTMLParser(html, {
        html5: true,
...
/* 全局的 ActiveXObject, DOMDocument 对象 */
...
// 空标签
var empty = makeMap('area,base,basefont,br,col,embed,frame,hr,img,input,isindex,keygen,link,meta,param,source,track,wb');
...
// 自身属性名当做值的属性，比如 disabled="disabled"
